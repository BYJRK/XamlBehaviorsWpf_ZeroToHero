...
<Window>
    <i:Interaction.Triggers>
        <i:EventTrigger EventName="Loaded">
            <b:InvokeCommandAction Command="{Binding MyCommand1}" />
        </i:EventTrigger>
    </i:Interaction.Triggers>
    ...
    <Border>
        <i:Interaction.Triggers>
            <i:EventTrigger EventName="MouseEnter">
                <b:InvokeCommandAction Command="{Binding MyCommand2}" />
            </i:EventTrigger>
        </i:Interaction.Triggers>
    </Border>
    ...
    <ListBox>
        <i:Interaction.Triggers>
            <i:EventTrigger EventName="SelectionChanged">
                <b:InvokeCommandAction Command="{Binding MyCommand3}" />
            </i:EventTrigger>
        </i:Interaction.Triggers>
    </ListBox>
</Window>
